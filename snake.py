...
if (check_errors[1] > 0):
    ...
    print("Game succesfully Initialiazed!")
...
while True:
    ...
    if not food_spawn:
        food_pos = [
            random.randrange(1, (frame_size_x // frame_size_y)) * square_size,
            random.randrange(1, (frame_size_y // square_size)) * square_size
        ]
    # GFX
